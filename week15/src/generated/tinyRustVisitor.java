...
public interface tinyRustVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link tinyRustParser#match_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatch_stmt(tinyRustParser.Match_stmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link tinyRustParser#match_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatch_expr(tinyRustParser.Match_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link tinyRustParser#match_conditional_expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatch_conditional_expr(tinyRustParser.Match_conditional_exprContext ctx);
	/**
	 * Visit a parse tree produced by {@link tinyRustParser#match_body}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMatch_body(tinyRustParser.Match_bodyContext ctx);
	/**
