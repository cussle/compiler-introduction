...
public class tinyR4Parser extends Parser {
    ...
    public static class Fun_declContext extends ParserRuleContext {
        ...
        public TerminalNode FUNC() {
            return getToken(tinyR4Parser.FUNC, 0);
        }
    ...
    public static class Type_specContext extends ParserRuleContext {
        ...
        public TerminalNode U32() {
            return getToken(tinyR4Parser.U32, 0);
        }
    ...
    public static class Ret_type_specContext extends ParserRuleContext {
        ...
        public TerminalNode RARROW() {
            return getToken(tinyR4Parser.RARROW, 0);
        }
    ...
    public static class Dec_specContext extends ParserRuleContext {
        ...
        public TerminalNode LET() {
            return getToken(tinyR4Parser.LET, 0);
        }

        public TerminalNode MUT() {
            return getToken(tinyR4Parser.MUT, 0);
        }
    ...
    public static class Relative_exprContext extends ParserRuleContext {
        ...
        public TerminalNode AND() {
            return getToken(tinyR4Parser.AND, 0);
        }

        public TerminalNode OR() {
            return getToken(tinyR4Parser.OR, 0);
        }
    ...
    public static class Comparative_exprContext extends ParserRuleContext {
        ...
        public TerminalNode EQ() {
            return getToken(tinyR4Parser.EQ, 0);
        }

        public TerminalNode NE() {
            return getToken(tinyR4Parser.NE, 0);
        }

        public TerminalNode LE() {
            return getToken(tinyR4Parser.LE, 0);
        }

        public TerminalNode GE() {
            return getToken(tinyR4Parser.GE, 0);
        }
    ...
    public static class If_stmtContext extends ParserRuleContext {
        ...
        public TerminalNode IF() {
            return getToken(tinyR4Parser.IF, 0);
        }
        ...
        public TerminalNode ELSE() {
            return getToken(tinyR4Parser.ELSE, 0);
        }
    ...
    public static class For_stmtContext extends ParserRuleContext {
        ...
        public TerminalNode FOR() {
            return getToken(tinyR4Parser.FOR, 0);
        }
    ...
    public static class Loop_stmtContext extends ParserRuleContext {
        ...
        public TerminalNode LOOP() {
            return getToken(tinyR4Parser.LOOP, 0);
        }
    ...
    public static class Return_stmtContext extends ParserRuleContext {
        ...
        public TerminalNode RETURN() {
            return getToken(tinyR4Parser.RETURN, 0);
        }
    ...
    public static class Break_stmtContext extends ParserRuleContext {
        ...
        public TerminalNode BREAK() {
            return getToken(tinyR4Parser.BREAK, 0);
        }
    ...
    public static class LiteralContext extends ParserRuleContext {
        ...
        public TerminalNode LITERAL() {
            return getToken(tinyR4Parser.LITERAL, 0);
        }
    ...
    public static class IdContext extends ParserRuleContext {
        ...
        public TerminalNode ID() {
            return getToken(tinyR4Parser.ID, 0);
        }
